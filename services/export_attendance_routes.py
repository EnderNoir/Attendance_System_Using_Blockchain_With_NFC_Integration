            ...
            rows.append(
                {
                    ...
                    'date_dash': '—' if status.lower() in ('absent', 'excused') else _fmt_date_dash(lg['started_at'] or ''),
                    'date_colon': '—' if status.lower() in ('absent', 'excused') else _fmt_date_colon(lg['started_at'] or ''),
