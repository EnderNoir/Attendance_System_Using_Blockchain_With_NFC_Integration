    ...
    *,
    ...
    sessions_json = {
        sess_id: {
            ...
            'semester': session_data.get('semester', '1st Semester'),
            'session_tx_hash': session_data.get('session_tx_hash', ''),
            'session_block_number': session_data.get('session_block_number', 0),
